...
app.post('/runquery', function(req, res) {
  ...
  switch(topic) {
    ...
    case 'q4':
      ...
      break;
    case 'q5':
      query = "SELECT agent.agent_id, agent.fname, agent.lname, AVG(properties.price) AS avg_price_2022, AVG(YEAR(NOW()) - properties.year_of_listing) AS avg_years_on_market FROM properties JOIN agent ON properties.agent_id = agent.agent_id WHERE  properties.year_of_listing = 2022 GROUP BY agent.agent_id";
      break;
    case 'q6':
