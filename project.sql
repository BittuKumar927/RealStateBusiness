-- Active: 1679026840982@@127.0.0.1@3306@realestate
...
create table agentlogin(username VARCHAR(50) not null , password VARCHAR(20) PRIMARY KEY);
...
drop TRIGGER insert_property_status;
...
ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'bittu@2343';
FLUSH PRIVILEGES;
mysql> ALTER USER 'username'@'localhost' IDENTIFIED WITH plugin_name BY 'password';
